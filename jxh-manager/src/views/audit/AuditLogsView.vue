...
@media(max-width:1100px){.audit-filters{grid-template-columns:repeat(4,minmax(120px,1fr)) auto 38px}.audit-grid{grid-template-columns:140px minmax(120px,.8fr) minmax(220px,1.5fr) 90px 16px}.audit-heading span:nth-child(5),.request-id{display:none}}
